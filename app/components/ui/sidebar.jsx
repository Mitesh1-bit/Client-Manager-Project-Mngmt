...
function SidebarInset({
  ...
  return (
    <main
      ...
      className={cn(
        // min-w-0: this is a row flex item next to the sidebar, and a flex
        // item's default `min-width: auto` lets wide content (a Gantt, a month
        // grid, a table) push the whole page sideways instead of scrolling
