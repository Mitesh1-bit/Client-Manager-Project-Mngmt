...
export const INTERNAL_ROLE_GUIDES = {
  admin: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Go to Settings → Add team member. Pick a role (account manager, project manager, etc.) and share login credentials securely.",
        href: "/settings",
  ...
  account_manager: {
    ...
    tagline: "You own client relationships, portal access, and retention.",
    steps: [
      {
        id: "welcome",
        title: "Your focus: clients",
        body: "You manage companies, contacts, and keeping clients engaged. You can enable portal logins and create projects for clients.",
        icon: "HeartHandshake",
      },
      {
        id: "company",
        title: "Maintain company records",
        body: "Keep client details up to date — status, contacts, and health. Active companies with open projects show on the dashboard.",
        href: "/companies",
        action: "Companies",
        icon: "Building2",
      },
      {
        ...
        body: "Each client contact needs portal access enabled and a password (12+ characters). They use /client-login — not staff login.",
        href: "/companies",
      ...
      {
        id: "project",
        title: "Spin up client projects",
        body: "Create projects linked to the right company. Coordinate with project managers on delivery timelines.",
        href: "/projects/new",
        action: "New project",
        icon: "FolderKanban",
      },
      {
        id: "retention",
        title: "Watch retention signals",
        body: "Use Retention to see at-risk clients and log touchpoints so nothing slips through the cracks.",
        href: "/retention",
        action: "Retention",
        icon: "Activity",
      },
      {
        ...
        body: "See what clients have asked to change. Work with PMs to assess and respond.",
        href: "/change-requests",
        action: "Change requests",
        icon: "GitPullRequestArrow",
      },
  ...
  finance_admin: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Open projects to see budget and dates. Coordinate with account managers on contract changes.",
        href: "/projects",
        action: "Projects",
        icon: "FolderKanban",
      },
